class OptionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @option.save
        format.html { redirect_to poll_question_path(@poll, @question), notice: 'Option was successfully created.' }
        format.json { render :show, status: :created, location: poll_question_path(@poll, @question) }
      else
