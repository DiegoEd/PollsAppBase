...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post polls_url, params: { poll: { description: @poll.description, title: @poll.title, version: @poll.version } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { description: @poll.description, title: @poll.title, version: @poll.version } }
